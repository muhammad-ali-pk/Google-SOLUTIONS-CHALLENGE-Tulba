...
<head>
    ...
    <title>Confirmation - Employer</title>
...
<body>
    <div id="Confirmation">
        <div id="Background">
            <svg class="Ellipse_9">
                <ellipse fill="rgba(31,90,80,1)" id="Ellipse_9" rx="54.5%" ry="46.5%" cx="54.5%" cy="46%">
                </ellipse>
            </svg>
            <svg class="Ellipse_8">
                <ellipse fill="rgba(31,90,80,1)" id="Ellipse_8" rx="53%" ry="47.5%" cx="53%" cy="47.5%">
                </ellipse>
            </svg>
        </div>
        <div id="Header">
            <img id="Tulba" src="{{ asset('assets/images/Logo.png') }}" >
            <a href="/employer/login" class="fadeIn">
        ...
        <div id="Congratulations_on_successfull" class="fadeIn">
            <span>Congratulations on successfully registering on Tulba!</span>
        </div>
    </div>
</body>
