...
<body style="background-image: url('{{ asset('assets/images/Background.png') }}');">
    ...
    <!-- Employer
<body class="emp-body" style="background-image: url('resources/img/Background_2_emp.png');">
-->
    <header>
        <nav>
            <div class="row">
                ...
                <ul class="main-nav js--main-nav">
                    ...
                    <li><a href="/student/stories">Stories</a></li>
                    <li><a href="/student/partners">Partners</a></li>
                    <!-- Student -->
                    <!-- Logged Out -->
            ...
            -->
                    ...
                    <li><a href="/student/login" class="btn btn-full btn-login">Login</a></li>
                    @else
                    ...
                    <!-- Employer -->
                    <!-- Logged Out
				<li><a href="employer-login.html" class="btn btn-full btn-login">Login</a></li>
				-->
                    <!-- Logged In
				<li class="profile-container">
					<img class="profile" alt="Profile Image" src="resources/img/model2.png">
					<div class="dropdown">
						<ul>
							<li><a href="profile-employer.html">My Profile</a></li>
							<li><a href="jobs-employer.html">My Jobs</a></li>
							<li><a href="index-employer.html">Log out</a></li>
						</ul>
					</div>
				</li>
				-->
