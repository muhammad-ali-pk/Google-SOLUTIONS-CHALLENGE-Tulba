...
<head>
    ...
    <link href="{{ asset('assets/styles/Student_W_Login_Home.css') }}" rel="stylesheet" type="text/css">
...
<body>
    <div id="Student_W_Login_Home">
        ...
        <div id="Home_pics">
            <img id="pic_2" src="{{ asset('assets/images/woman_writing_on_a_notebook.png') }}">
            <img id="pic_1" src="{{ asset('assets/images/group_of_people_sitting.png') }}">
        </div>
        <div id="Text_quote">
            <div id="Opportunity_is_missed_by_most_">
                <span>Opportunity is missed by most people<br />because it is dressed in
                    overalls and<br />looks like work.</span>
            </div>
            <div id="_">
                <span>"</span>
            </div>
